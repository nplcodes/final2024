...
import { BsDot, BsEye, BsListTask, BsPlus } from "react-icons/bs";
import { BiMessage, BiCommentEdit } from "react-icons/bi";
import { TiDeleteOutline } from "react-icons/ti";

import { AiOutlineClockCircle, AiOutlineProfile } from "react-icons/ai";
    ...
    <div className='p-20 gap-20 w-full  grid grid-cols-6'>
        <div className='pt-10 flex flex-col p-10 gap-3 col-span-1'>
            ...
            <Link to="/Home/new-issue">
               <div  className='p-5 text-2xl hover:bg-blue-400 hover:text-white cursor-pointer'><BsPlus /></div>
            </Link>
        ...
        <div className='col-span-5'>
            <div className='pb-10'>
                <p className='text-blue-500'>My Issue Page </p>
            </div>
