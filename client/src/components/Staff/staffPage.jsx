...
//         {/* Left Div - List of Issues */}
//         <div className="w-3/5 mr-8">
//           <h1 className="text-2xl font-semibold mb-4">New Issues</h1>
//           <div className="space-y-4">
//             {issues.map((issue) => (
//               <div key={issue.id} className="bg-white p-4 shadow-md rounded-lg flex items-center justify-between">
//                 <div>
//                   <h2 className="text-lg font-semibold">{issue.title}</h2>
//                   <p className="text-gray-600">{issue.description}</p>
//                 </div>
//                 <button
//                   onClick={() => assignIssueToStaff(issue._id)}
...
//           </div>
//         </div>
//         {/* Right Div - Recent Received Issues */}
//         <div className="w-2/5">
//           <h5 className="text-2xl font-semibold mb-4">recent issues</h5>
//           <div className="space-y-4">
