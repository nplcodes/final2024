    ...
    >
      <div className="flex flex-col items-center p-4">
        ...
        <div className="p-3 border-b border-1">
          <p className='text-black text-4xl font-bold'><img src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBQUDxIPEhIVEhISFQ0VEhIVDR8NGg0aJSEnJyUhJCQpJTczKSw4LSQYND00OD0/Q0NDK
